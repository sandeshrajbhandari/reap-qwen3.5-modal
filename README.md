...
- **`quantize_qwen36_mtp_q3ks_modal.py`**: ik_llama.cpp-based plain Q3_K_S requantizer for `Radamanthys11/Qwen3.6-27B-MTP-Q8_0-GGUF`, preserving MTP tensors, building ik_llama.cpp on T4, and uploading to the authenticated Hugging Face account by default. This path does not generate or use an imatrix.

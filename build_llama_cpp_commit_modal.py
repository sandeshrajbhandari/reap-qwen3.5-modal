...
app = modal.App("llama-cpp-commit-cuda-build-upload")
...
def build_smoke_test_and_upload(
    hf_repo: str,
    llama_ref: str = "5d5f1b46e4f56885801c86363d4677a5f72f83af",
    llama_repo_url: str = "https://github.com/ggml-org/llama.cpp.git",
    artifact_prefix: str = "llama-cpp-cuda-default-5d5f1b46-colab",
    latest_path: str = "builds/latest-llama-cpp-cuda.txt",
    ...
    source_dir = pathlib.Path("/tmp/llama.cpp")
    ...
    print(f"Building llama.cpp commit {short_sha}")
    ...
    metadata = {
        ...
        "version_stdout": version_output.stdout,
    ...
    latest_file = pathlib.Path("/tmp/latest-llama-cpp-cuda.txt")
...
def main(
    ...
    print("llama.cpp build + upload completed.")
    print(json.dumps(result, indent=2))
